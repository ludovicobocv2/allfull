...
const PixPayment: React.FC<PixPaymentProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Pagamento via PIX</h2>
      
      {isLoading ? (
        <div className="flex justify-center items-center p-6">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-financas-primary"></div>
          <span className="ml-3 text-gray-700 dark:text-gray-300">Gerando QR Code...</span>
        </div>
      ) : error ? (
        ...
        <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 p-4 rounded-lg mb-4">
          ...
          <button
            className="mt-3 bg-financas-primary text-white px-4 py-2 rounded-lg hover:bg-financas-secondary"
            onClick={onSuccess}
          >
            Continuar
          </button>
        ...
        <div>
          <div className="flex flex-col items-center mb-4">
            ...
            <div className="bg-white p-2 border dark:border-gray-600 rounded-lg mb-4">
              {/* QR Code como imagem */}
              <img
                src={pixData.qrcode}
                alt="QR Code PIX"
            ...
            <div className="w-full">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Código PIX copia e cola:</p>
              <div className="flex">
                <input
                  type="text"
                  readOnly
                  value={pixData.pixCopiaECola}
                  className="flex-1 p-2 border dark:border-gray-600 rounded-l-lg bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-xs overflow-hidden"
                />
                <button
                  onClick={copyPixCodeToClipboard}
                  className="bg-financas-primary text-white px-3 py-2 rounded-r-lg hover:bg-financas-secondary"
                >
                  Copiar
                </button>
              </div>
          ...
          <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
            <h3 className="font-medium mb-2 text-gray-900 dark:text-white">Instruções:</h3>
          ...
          <button
            className="mt-4 w-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600"
            onClick={onCancel}
          >
            Cancelar
          </button>
