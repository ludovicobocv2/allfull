...
const AssistantChat: React.FC<AssistantChatProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      {/* Cabeçalho */}
      <div className="bg-hiperfocos-primary text-white p-4 rounded-t-lg">
        <h2 className="text-xl font-semibold">Assistente StayFocus</h2>
        <p className="text-sm opacity-90">Seu assistente personalizado para TDAH</p>
      </div>
      ...
      <div className="flex-1 p-4 overflow-y-auto">
          ...
          >
            <div 
              className={`inline-block p-3 rounded-lg ${
                message.isUser 
                  ? 'bg-hiperfocos-primary text-white rounded-br-none' 
            ...
            {!message.isUser && onSendToWhatsApp && (
              <button
                ...
                className="text-xs text-hiperfocos-primary dark:text-hiperfocos-secondary hover:underline ml-2"
              >
        ...
        {isLoading && (
          <div className="text-left mb-4">
            <div className="inline-block p-3 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-bl-none">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 p-4">
        <div className="flex">
          <textarea
            className="flex-1 border dark:border-gray-600 rounded-l-lg p-2 resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-hiperfocos-primary"
          ...
          />
          <button
            className="bg-hiperfocos-primary text-white px-4 py-2 rounded-r-lg hover:bg-hiperfocos-secondary transition focus:outline-none disabled:bg-hiperfocos-secondary disabled:opacity-50"
            onClick={sendMessage}
